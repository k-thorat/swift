...
static void printRelatedIdents(sourcekitd_variant_t Info, StringRef Filename,
                               const llvm::StringMap<TestOptions::VFSFile> &VFSFiles,
                               llvm::raw_ostream &OS);
static void printInactiveRanges(sourcekitd_variant_t Info, StringRef Filename,
                               const llvm::StringMap<TestOptions::VFSFile> &VFSFiles,
                               llvm::raw_ostream &OS);
...
#include "swift/Refactoring/RefactoringKinds.def"
  ...
  case SourceKitRequest::InactiveRanges:
    sourcekitd_request_dictionary_set_uid(Req, KeyRequest, RequestInactiveRanges);
    break;
...
static bool handleResponse(sourcekitd_response_t Resp, const TestOptions &Opts,
  ...
  if (IsError) {
    ...
    case SourceKitRequest::InactiveRanges:
      printInactiveRanges(Info, SourceFile, Opts.VFSFiles, llvm::outs());
      break;
